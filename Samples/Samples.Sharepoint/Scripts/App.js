...
function createMetadata() {
  ...
  addType({
    name: 'Settings',
    defaultResourceName: 'getbytitle(\'IBMConnectionsSettings\')/items',
    dataProperties: {
      Id: { nullable: false },
...
function initBreeze() {
  ...
  contactType = metadataStore.getEntityType('Settings');
    ...
    .then(function (response) {
      ...
      if (results && results.length) {
        ...
        for (var index = 0; index < results.length; index++) {
          message += results[index].ID + ':' + results[index].Title + ' (' + results[index].Value + ')<br/>';
        }
